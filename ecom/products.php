...
<head>
    ...
    <title>Happy Girls | Online Shopping Site for Girls</title>
...
<div class="container" style="margin-top:65px">
    ...
    <hr/>
    <!--menu list-->
    <div class="row text-center" id="bags">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/bag1.png" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Contrasting Miny City Bag</h6>
                    <h6>49.90 USD</h6>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/bag2.png" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Pearl Detail Basket Bag</h6>
                    <h6>35,99 USD</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/bag3.png" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Ruffled Fabric Shoulder Bag</h6>
                    <h6>49.90 USD</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/bag4.png" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Pack Of Travel Bags</h6>
                    <h6>35.99 USD</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    ...
                    <div class="figure-caption">
                    <h6>Oversized Cotton T-shirt</h6>
                    <h6>19.90 USD</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="row text-center" id="shoes" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        ...
                        <div class="figure-caption">
                            <h6>Combined Athletic Sneakers</h6>
                            <h6>35.99 USD</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        ...
                        <div class="figure-caption">
                            <h6>Fabric High Top Sneakers</h6>
                            <h6>29.99 USD</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        ...
                        <div class="figure-caption">
                        <h6>Athletic Platform Sneakers</h6>
                    <h6>35.99 USD</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="row text-center" id="skirts">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="images/skirt1.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Gothic Black Pleated Buckle Skirt</h6>
                                <h6>36.96 USD</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/skirt2.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Pink and Black Plaid Gothic</h6>
                                <h6>41.36 USD</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/skirt3.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Cute Punk Skirt</h6>
                                <h6>37.22 USD</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/skirt4.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Plaid Women Pleated Skirt Bow Knot</h6>
                                <h6>27.08 USD</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
